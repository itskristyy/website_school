...
$sql = mysqli_query($koneksi, "UPDATE tb_berita
                              SET judul_berita='$judul_berita', url_image='$url_image', deskripsi_berita='$deskripsi_berita', kategori_berita='$kategori_berita', created_at='$created_at', updated_at='$updated_at' 
