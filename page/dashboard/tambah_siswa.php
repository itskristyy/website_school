    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="container-fluid p-4 p-md-5" style="background-color: var(--skn-bg);">
            <div class="d-flex align-items-center gap-3 mb-4">
                <h1 class="font-headline fw-bold m-0" style="color: var(--skn-primary);">Tambah Siswa</h1>
            ...
            <div class="card shadow-sm border-0 rounded-0" style="border-top: 4px solid var(--skn-primary) !important;">
                <div class="card-header bg-white border-bottom-0 pt-4 pb-0">
                    <p class="font-mono small text-muted">Masukkan detail Siswa di bawah ini.</p>
                </div>
                <div class="card-body p-4">
                    <form action="../../function/function_siswa/add_siswa.php" method="POST">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <label for="nipd" class="form-label fw-semibold">NIPD</label>
                            <input type="text" class="form-control" name="nipd" id="nipd"
                                placeholder="Masukkan nipd" required>
                        </div>

                        <div class="mb-4">
                            <label for="siswa_jurusan" class="form-label fw-semibold">Jurusan</label>
                            <select name="siswa_jurusan" id="siswa_jurusan" class="form-control" required>
                        ...
                        <div class="d-flex gap-3 mt-5">
                            <button type="submit" class="btn fw-bold font-mono clip-diag btn-shadow text-uppercase px-4" style="background-color: var(--skn-amber); color: var(--skn-primary);">Simpan Siswa</button>
