    ...
    <main class="d-flex flex-nowrap">
        ...
        <div class="container-fluid p-4 p-md-5" style="background-color: var(--skn-bg);">
            <div class="d-flex align-items-center gap-3 mb-4">
                <h1 class="font-headline fw-bold m-0" style="color: var(--skn-primary);">Data Alumni</h1>
                    ...
                    if (mysqli_num_rows($data) > 0) {
                        while ($row = mysqli_fetch_array($data)) {
                            ...
                            <tr>
                                ...
                                <td><?php echo htmlspecialchars($row['nama_alumni']); ?></td>
                                <td><?php echo htmlspecialchars($row['alumni_jurusan']); ?></td>
                                <td><?php echo htmlspecialchars($row['tahun_lulus']); ?></td>
                                <td>
                                    <a href="../../function/function_alumni/delete_alumni.php?id_alumni=<?php echo $row['id_alumni']; ?>" class="btn fw-bold font-mono btn-outline-danger rounded-0 text-uppercase px-3 py-1" style="font-size: 0.8rem;" onclick="return confirm('Yakin hapus?');">Hapus</a>
                                </td>
                            </tr>
                            <?php
                        }
                    } else {
                        echo "<tr><td colspan='4' class='text-center'>Belum ada data alumni.</td></tr>";
                    }
                    ?>
                </tbody>
            </table>
